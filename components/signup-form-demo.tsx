...
export default function SignupFormDemo() {
  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black outline-none">
      <h2 className="font-bold text-xl text-neutral-800 dark:text-neutral-200">
        Join <span className="text-blue-600 dark:text-blue-300">Stime</span>
      </h2>
